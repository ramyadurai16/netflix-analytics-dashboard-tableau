...
This project presents an interactive Tableau dashboard built using Netflix dataset. It visualizes key insights such as content growth, genres distribution, ratings analysis, country-wise breakdown, and yearly trends.
The dashboard helps users explore patterns in Netflix movies and TV shows through dynamic charts, KPIs, filters, and storytelling visuals.
